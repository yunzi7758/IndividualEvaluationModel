 ...
 *
 */
public class CountScoreMap extends RichMapFunction<String, List<IaOutData>> {
    ...
    @Override
    public List<IaOutData> map(String inputStr) throws Exception {
